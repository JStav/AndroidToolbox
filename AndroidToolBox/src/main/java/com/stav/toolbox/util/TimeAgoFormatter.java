...
public class TimeAgoFormatter implements TextFormatter {
   ...
   *
   * @return "time ago" string or null if the timestamp is not set or 0. (results in TextView being
   * blank)
   */
  @Override public String format() {
    if (mTimestamp != 0) {
      return DateUtils.getRelativeTimeSpanString(mTimestamp, System.currentTimeMillis(),
